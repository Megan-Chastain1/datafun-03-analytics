...
and saves it to a local file named AvocadoPrices.xlsx in a folder named Megan_data.
...
def main():
    ...
    """
    excel_url = 'https://github.com/rohanmistry231/Practice-Datasets-for-Excel/raw/refs/heads/main/Avacado%20Prices/avocado.xlsx'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(FETCHED_DATA_DIR, "AvocadoPrices.xlsx", excel_url)
