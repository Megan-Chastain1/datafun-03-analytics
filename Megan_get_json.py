...
from the web and saves it to a local file named Megan_data/Nobel.json.
...
def main():
    ...
    """
    json_url = 'https://api.nobelprize.org/v1/prize.json'
    logger.info("Starting JSON fetch demonstration...")
    fetch_json_file(FETCHED_DATA_DIR, "Nobel.json", json_url)
