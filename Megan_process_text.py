...
PROCESSED_DIR: str = "Megan_processed_text"
...
def process_text_file():
    ...
    input_file = pathlib.Path(FETCHED_DATA_DIR, "pride.txt")

   
    output_file = pathlib.Path(PROCESSED_DIR, "text_pride_word_count.txt")

    
    word_to_count: str = "Darcy"
